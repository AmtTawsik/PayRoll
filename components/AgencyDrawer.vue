...
<template>
	<div id="drawer-right"
		...
		<!-- 62-88 -->
		<!-- <div class="rounded border border-slate-300 m-4">
			<div class="p-4 grid grid-cols-[40fr_60fr] gap-y-4 max-lg:grid-cols-1">
				...
				<div>
					<span class="text-slate-500 text-sm font-medium">Company number</span>
					<p class="text-sm font-semibold text-gray-700">
						{{ currRecord?.companyNumber }}
					</p>
				</div>
				<div>
					<span class="text-slate-500 text-sm font-medium">VAT number</span>
					<p class="text-sm font-semibold text-gray-700">{{ currRecord?.vatNumber }}</p>
				</div>

				<div>
					<span class="text-slate-500 text-sm font-medium">Company status</span>
					<p class="text-sm font-semibold text-gray-700">
						{{ currRecord?.companyStatus }}
					</p>
				</div>
			</div>
		</div> -->
